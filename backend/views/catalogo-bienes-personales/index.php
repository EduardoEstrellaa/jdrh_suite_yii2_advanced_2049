...
$this->title = Yii::t('app', 'Catalogo Bienes Personales');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="catalogo-bienes-personales-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, CatalogoBienesPersonales $model, $key, $index, $column) {
