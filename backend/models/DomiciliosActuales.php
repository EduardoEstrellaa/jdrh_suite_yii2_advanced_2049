 ...
 */
class DomiciliosActuales extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['perfil_id', 'entidades_federativas_id', 'municipios_id', 'localidades_id', 'calle', 'numero_exterior', 'colonia', 'codigo_postal'], 'required'],
            [['perfil_id', 'entidades_federativas_id', 'municipios_id', 'localidades_id'], 'integer'],
            [['calle', 'colonia'], 'string', 'max' => 150],
            [['numero_exterior', 'numero_interior'], 'string', 'max' => 15],
