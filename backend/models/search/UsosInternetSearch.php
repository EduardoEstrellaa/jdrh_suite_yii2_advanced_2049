...
class UsosInternetSearch extends UsosInternet
{
    ...
    {
        return [
            [['id', 'alum_recreacion_tiempo_id', 'catalogo_usos_internet_id'], 'integer'],
        ];
    }
    ...
    public function search($params, $formName = null)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'alum_recreacion_tiempo_id' => $this->alum_recreacion_tiempo_id,
            'catalogo_usos_internet_id' => $this->catalogo_usos_internet_id,
        ]);
