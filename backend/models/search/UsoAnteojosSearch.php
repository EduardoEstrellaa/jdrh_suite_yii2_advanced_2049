...
class UsoAnteojosSearch extends UsoAnteojos
{
    ...
    {
        return [
            [['id', 'alum_uso_anteojos_id', 'catalogo_uso_anteojos_id'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'alum_uso_anteojos_id' => $this->alum_uso_anteojos_id,
            'catalogo_uso_anteojos_id' => $this->catalogo_uso_anteojos_id,
        ]);
