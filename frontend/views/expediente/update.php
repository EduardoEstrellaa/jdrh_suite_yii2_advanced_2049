...
<div class="expediente-update">
    ...
    <?= $this->render('_form', [
        ...
        'alumDeportes' => $alumDeportes ?? null,
        'alumEjercicio' => $alumEjercicio ?? null,
        'alumHabitosConsumo' => $alumHabitosConsumo ?? null,
        'catalogoDeportesMap' => $catalogoDeportesMap ?? [],
        'catalogoActividadesEjercicioMap' => $catalogoActividadesEjercicioMap ?? [],
        'frecuenciasVecesSemanaMap' => $frecuenciasVecesSemanaMap ?? [],
        'catalogoCigarrosDiaMap' => $catalogoCigarrosDiaMap ?? [],
        ...
        'alumRecreacionTiempo' => $alumRecreacionTiempo ?? null,
        'catalogoLugaresAccesoMap' => $catalogoLugaresAccesoMap ?? [],
        'catalogoUsosInternetMap' => $catalogoUsosInternetMap ?? [],
