...
class AlumDatosFamiliares extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['alumnos_id', 'padre_nombre', 'padre_apellido_paterno', 'padre_apellido_materno', 'padre_ocupacion', 'padre_mayahablante', 'madre_nombre', 'madre_apellido_paterno', 'madre_apellido_materno', 'madre_ocupacion', 'madre_mayahablante'], 'required'],
            [['alumnos_id', 'padre_mayahablante', 'madre_mayahablante'], 'integer'],
